          ...
          <div className="relative">
            ...
            <form className="relative">
              ...
              <Button
                type="submit"
                size="icon"
                className="absolute right-1 top-1 h-8 w-8 rounded-full bg-gray-900 text-white transition-transform hover:scale-105 hover:bg-gray-800"
              >
                <Send className="h-4 w-4" />
                <span className="sr-only">Subscribe</span>
              </Button>
            </form>
            <div className="absolute -right-4 top-0 h-24 w-24 rounded-full bg-gray-100 blur-2xl" />
          </div>
          <div>
            ...
            <nav className="space-y-2 text-sm">
              ...
              <a href="#about" className="block transition-colors hover:text-gray-900">
                About Us
              </a>
              <a href="#work" className="block transition-colors hover:text-gray-900">
                Work
              </a>
              <a href="#projects" className="block transition-colors hover:text-gray-900">
                Projects
              </a>
              <a href="#contact" className="block transition-colors hover:text-gray-900">
                Contact
              </a>
            </nav>
          </div>
